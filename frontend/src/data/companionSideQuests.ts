...
const AILIN_SIDE_QUEST: CompanionSideQuestDef = {
  ...
  fixedIntro: [
    { speaker: '主持人', text: '尼布把浅层地图压在补给箱上，转身去找巡逻日志。布洛克蹲在平台边缘辨认风向，凯娅拆开第一只补给箱的封扣，队伍暂时被分成几条整备线。', },
    { speaker: '主持人', text: '艾琳没有打断整备，只是把药箱放到伤员棚门口。帘布后传来压抑的咳嗽声，染蓝的绷带堆在铁盆里，白枝木牌上写着上一批巡逻队的名字。', },
    { speaker: '艾琳', text: '「给我一刻钟。我先判断污染有没有扩散，能稳定一个算一个。等尼布把路线核完，我们再一起出发。」', portrait: '/assets/characters/ailin/ailin_white_branch.webp', },
    { speaker: '尼布', text: '「他们是上一批巡逻队。能站着回来的只有两个，能说完整话的一个都没有。」', },
    { speaker: '瑟琳', text: '「我们不会因此耽误路线确认。相反，他们可能知道蓝伞浅滩为什么突然变亮。」', },
...
const KAIYA_SIDE_QUEST: CompanionSideQuestDef = {
  ...
  fixedIntro: [
    ...
    { speaker: '凯娅', text: '「少了两个封扣，切口很新。不是魔物咬的，是人手。」', portrait: '/assets/characters/kelaiya/kaiya_blackmarket.webp', },
