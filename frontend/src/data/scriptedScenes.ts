...
const GUILD_ARRIVAL: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: '米娜',
      text: '「艾琳是静默神殿的白枝修女。她擅长治疗、净化、稳定恐惧，也懂牺牲者遗物里的宗教线索。缺点是她不会接受抛下伤者的决定。」',
    },
    {
      speaker: '米娜',
      text: '「布洛克·铁锅常在回声酒馆出没。他懂孢海生态、生存路线和样本采集，能闻出哪些菌毯会吃人。缺点是脾气硬，报酬和采样条件谈不拢就不走。」',
    },
    {
      speaker: '米娜',
      text: '「凯娅不在任何公开名单上。她会开锁、拆陷阱、看黑市暗号，也懂哪些人正在卖假情报。缺点是她只认能兑现的筹码。」',
    },
    {
      speaker: '赫尔曼',
    ...
    {
      speaker: '米娜',
      text: '「三人的位置和性格细节，我这里不能写进公会明档。去回声酒馆找萨洛。他的情报很准，但他的规矩也烦人——陪他玩一局快艇骰子，他才会把话说全。」',
    },
    {
      speaker: '瑟琳',
...
const TAVERN_INTRO: ScriptedScene = {
  ...
  lines: [
    {
      speaker: '主持人',
      text: '回声酒馆藏在倒挂街区一条侧巷里。炉火、麦酒、潮湿木梁和旧皮革的气味混在一起，天花板上垂着一排铜铃，每当城市主缆震动，铃声就像很远的回音。',
    },
    {
      speaker: '萨洛',
    ...
    {
      speaker: '瑟琳',
      text: '「我们需要艾琳、布洛克和凯娅的位置，也需要你对他们的判断。」',
    },
    {
      speaker: '萨洛',
    ...
    {
      speaker: '瑟琳',
      text: '「我的银杖能短时间看穿骰面。我可以给你建议，但最后保留什么、重掷什么，还是你决定。」',
    },
  ],
  hints: ['接受骰子游戏'],
};
...
const SALO_COMPANION_INTEL: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: '萨洛',
      text: '「布洛克就在我这儿，但他现在不想见公会的人。他懂孢海，尤其是样本、菌毯、毒囊和怪物迁徙。想让他走，给他采样许可和报酬，还得陪他玩一轮喝酒骰子。」',
    },
    {
      speaker: '萨洛',
...
const BROCK_TAVERN_INTRO: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: '布洛克',
      text: '「那就简单。第一，帮我采集三份活性孢子样本。第二，按规矩付报酬。第三，先陪我玩一轮喝酒骰子。连骰子都不敢拼的人，进孢海只会浪费绷带。」',
    },
    {
      speaker: '萨洛',
