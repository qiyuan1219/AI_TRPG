import { POST_BLUE_SHOAL_SCENES } from "./postBlueShoalStory";
...
export interface ScriptedScene {
  ...
  battlePrep?: Array<{
    ...
    check?: { skill: string; altSkill?: string; dc: number; label: string };
    successText: string;
...
const KAIYA_PASSPHRASE_CLUE = {
  ...
  name: "凯娅的暗号",
  description:
    '萨洛在酒馆告诉你的黑市暗号是"断缆不问来路"。到黑市找凯娅时，必须亲口说出这句话，她才愿意听完来意。',
  source: "回声酒馆 · 萨洛",
  tags: ["凯娅", "黑市", "暗号", "招募"],
  icon: "note-pin",
};
...
const OPENING: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "出发前，公会要求你补完最后一份登记档案。那不是职业证明，也不是头衔认证，而是一份关于“你通常如何活下来”的记录。",
    },
    {
      speaker: "主持人",
      text: "有人依靠体魄和耐力穿过危险，有人依靠速度和警觉避开死亡；有人擅长分析异常规则，也有人更懂得与活人、伤员和幸存者交谈。",
    },
    {
      speaker: "主持人",
      text: "在幽暗地域里，所谓流派并不代表身份高低。它只说明当危险降临时，你会本能地选择哪一种方式面对它。",
    },
    {
      speaker: "主持人",
      text: "你在登记页上停下笔，开始确认自己的冒险者流派。",
    },
...
const OPENING_SUSPENSE: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "主持人",
      text: "瑟琳转身走向街口。她的步子不快，却很稳，像是已经习惯在这座倒悬城市的边缘行走。",
    },
    {
      speaker: "主持人",
      text: "你跟在她身后，穿过一条由黑石与金属梁架成的主缆街。街道一侧是倒挂的民居与商铺，另一侧则能看见深井下方翻涌的蓝绿色孢光。",
    },
    {
      speaker: "瑟琳",
      text: "「逆穹城的道路不按地面城市的逻辑运转。这里的街区靠主缆、绞盘和符文制动维持稳定。听见钟声、缆鸣或者金属崩裂声时，第一反应不是抬头看，而是先确认脚下。」",
    },
    {
      speaker: "主持人",
      text: "她说话时，远处一条粗大的秘银缆索低低震动，声音沉闷得像某种巨兽在石层深处翻身。行人们对此并不惊讶，只是熟练地往街道内侧让了让。",
    },
    {
      speaker: "瑟琳",
      text: "「近一个月，这种异常缆鸣越来越频繁。城防署说只是负载问题，但我不这么认为。」",
    },
    {
      speaker: "主持人",
      text: "你注意到街边有几名工匠正在检查吊运轨道。木箱、补给袋和矿石吊篮被悬挂在半空，沿着缆车轨道缓慢移动。每只吊箱外侧都贴着封条，封条上印着公会与城防署的双重印记。",
    },
    {
      speaker: "瑟琳",
      text: "「公会登记处就在前面。登记之后，你会拿到临时通行许可。没有它，你无法进入缆梯中枢，也无法接触远征队档案。」",
    },
    {
      speaker: "主持人",
      text: "她停顿了一下，目光扫过你腰间的装备，又落回街道前方。",
    },
    {
      speaker: "瑟琳",
      text: "「在此之前，记住一件事：这座城市看起来还在运转，不代表它安全。逆穹城只是习惯了把危险藏在日常里面。」",
    },

    {
      speaker: "主持人",
      text: "你们刚走出街口，前方便传来一阵刺耳的警铃。街边的符文灯同时闪烁，几名工匠猛地抬头，脸色瞬间变了。",
    },
...
const TUTORIAL_BATTLE_AFTER: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "主持人",
      text: "最后一只裂隙爬兽被银白色光芒逼退，撞在吊箱边缘，蜷缩着失去了攻击性。",
    },
    {
      speaker: "主持人",
      text: "它没有继续扑咬，反而本能地缩向吊箱阴影深处，像是那道光比刀刃更让它恐惧。",
    },
    {
      speaker: "瑟琳",
      text: "「没有重伤。很好，你的反应速度比大部分第一次进悬城的人快。」",
    },
    {
      speaker: "瑟琳",
      text: "「不过你也看到了，它们对银白光的反应很异常。普通野兽不会这样退缩。」",
    },
    {
      speaker: "守卫",
      text: "「这是从孢海据点回收的空箱。最近三个月，类似事件发生了四次。」",
    },
    {
      speaker: "守卫",
      text: "「可问题是，补给吊箱入城前都会检查封条。按记录，这只箱子不该被打开过。」",
    },
    {
      speaker: "主持人",
      text: "守卫蹲下查看吊箱边缘。箱门的铜封条还挂在锁扣上，但封蜡内侧有一道不太明显的黑蓝色刮痕。",
    },
    {
      speaker: "主持人",
      text: "那痕迹不像是从外面撬开的，倒像是有什么东西曾经贴着箱壁，被硬生生拖进了里面。",
    },
    {
      speaker: "守卫",
      text: "「感谢你们出手。如果让它们冲进吊桥区，今天的通行记录上就要多几行红字了。这里有一些补给物资，请收下吧。」",
    },
    {
      speaker: "主持人",
      text: "守卫把一只应急补给袋递给你，又警惕地看了一眼吊箱封条。",
    },
    {
      speaker: "瑟琳",
      text: "「不是偶然。它们不是主动潜进来的——箱壁内侧有拖痕，像是被什么东西赶上去的。」",
    },
    {
      speaker: "瑟琳",
      text: "「而且它们怕的未必是光本身。刚才我的术式里混了逆钟学派的净化银辉，可能刺激到了它们体内的裂隙孢核。」",
    },
    {
      speaker: "主持人",
      text: "主缆街短暂安静下来，远处城市缆索发出低沉震响。吊箱残骸旁，封条、拖痕和魔物畏光的反应都显得格外刺眼。",
    },
    {
      speaker: "守卫",
      text: "「冒险者公会在倒挂塔楼区，顺着主缆走到底。你们的委托应该需要先登记。」",
    },
    {
      speaker: "守卫",
      text: "「当然，如果你们想在离开前多看一眼吊箱封条，我不会拦着。只是别碰里面残留的孢粉。」",
    },
    { speaker: "瑟琳", text: "「先过去也可以。米娜应该已经在等你了。」" },
    {
      speaker: "瑟琳",
      text: "「但如果你想问那些魔物为什么怕光，现在问我也来得及。这个现象，可能和孢海深处的异常有关。」",
    },
  ],
  hints: [
    "放弃调查，直接前往冒险者公会登记",
...
const GUILD_ARRIVAL: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "你与瑟琳沿主缆街来到冒险者公会。倒悬的石砌塔楼嵌在街区中央，铁制剑盾徽记悬在门外，被主缆震动带得轻轻摇晃。",
    },
    {
      speaker: "主持人",
      text: "墙上贴满泛黄的任务单与悬赏令，许多名字被红墨划去，旁边只留下简短的备注：失联、阵亡、未归。",
    },
    {
      speaker: "主持人",
      text: "大厅炉火烧得很旺，空气里却仍有地底特有的潮冷。文书员围在地图旁低声交谈，黑缆守卫将一只沾血的回收箱抬到柜台前，封条上还凝着暗色的泥。",
    },
    {
      speaker: "主持人",
      text: "柜台后的年轻女性抬起头。她戴着细框眼镜，深栗色卷发被整齐束在肩后，桌面上的登记册、铜牌和羽笔排得像一场即将开始的审判。",
    },
    {
      speaker: "米娜",
    ...
    {
      speaker: "主持人",
      text: "她语速很快，却没有催促。每说一句，笔尖便在纸上落下一道清晰的墨痕，像是要把混乱的局势强行整理出秩序。",
    },
    {
      speaker: "米娜",
      text: "「这次不是普通委托。按照公会和城防联合条例，进入无光孢海的远征队不得少于五人。」",
    },
    {
      speaker: "米娜",
      text: "「现在队伍里只有你和瑟琳。剩下的成员，至少要补上治疗与净化、深层生存、地下渠道这三块短板。」",
    },
    {
      speaker: "主持人",
      text: "米娜将三枚空白铜牌放在地图上。铜牌落下时发出沉闷的轻响，分别压住了静默神殿、深层矿道和黑市附近的标记。",
    },
    {
      speaker: "米娜",
      text: "「治疗者能处理孢毒、伤口和精神崩溃；深层向导能判断风向、菌毯和魔物迁徙；懂地下渠道的人，能处理锁具、陷阱、黑市交易和那些不会写进公会档案的麻烦。」",
    },
    {
      speaker: "瑟琳",
      text: "「也就是说，我们必须先找到合适的队友，才能领取下潜许可。」",
    },
    {
      speaker: "米娜",
      text: "「没错。公会不会替你们随便点名。深层远征靠的不只是能力，还要看这些人愿不愿意信任你们。」",
    },
    {
      speaker: "主持人",
      text: "话音刚落，大厅另一侧传来金属手杖敲击石面的声音。交谈声渐渐低了下去，连炉火爆开的轻响都显得格外清楚。",
    },
    {
      speaker: "主持人",
      text: "赫尔曼·断缆从地图阴影中走出。他穿着黑色长大衣，衣领扣得一丝不苟，右眼前的黑石单片镜泛着冷光。那张脸并不苍老，却像被十年的坏消息磨出了棱角。",
    },
    { speaker: "赫尔曼", text: "「五人编队不是形式，是底线。」" },
    {
      speaker: "主持人",
      text: "他停在地图前，戴着皮手套的手指按住地底堡垒的位置。那枚标记已经被反复摩擦，边缘发白，像一道迟迟没有愈合的旧伤。",
    },
    {
      speaker: "赫尔曼",
      text: "「地底堡垒已经失联十年。十年里，我们送下去的队伍够填满这间大厅，可回来的消息，连一页纸都写不满。」",
    },
    {
      speaker: "主持人",
      text: "黑缆守卫低头站在一旁，沾血的回收箱还没有打开。赫尔曼的目光扫过箱子，只停了一瞬，便重新落回你身上。",
    },
    {
      speaker: "赫尔曼",
      text: "「最近三个月，深层魔物的活动频率增加了三倍。孢海风向异常，主缆震动提前，连城市下缘的巡逻队都开始带回不该出现在浅层的爪痕。」",
    },
    { speaker: "瑟琳", text: "「所以这不是一次普通远征。」" },
    { speaker: "赫尔曼", text: "「普通远征不会把你们叫到这里。」" },
    {
      speaker: "主持人",
      text: "他的声音不高，却压得大厅里没人插话。那不是威胁，更像是一个人把最坏的结果提前摆在桌面上，逼所有人看清楚。",
    },
    {
      speaker: "赫尔曼",
      text: "「少于五人的队伍不准下潜。这不是怀疑你的能力，是因为我们已经为\u2018自信\u2019付过太多代价。」",
    },
    {
      speaker: "赫尔曼",
      text: "「我要的不是几个写在登记册上的名字，也不是一支看起来像样的队伍。我要的是有人抵达堡垒，查清沉默的原因，然后活着回来。」",
    },
    {
      speaker: "米娜",
      text: "「公会明档里能调动的人手有限。真正适合这次远征的人，未必愿意把名字挂在任务墙上。」",
    },
    {
      speaker: "米娜",
      text: "「去回声酒馆找萨洛。他不是公会的人，但他知道谁最近还活着，谁有本事，谁又可能愿意接这种麻烦。」",
    },
    {
      speaker: "米娜",
      text: "「不过他有个规矩：先陪他玩一局快艇骰子。赢了，他才会判断你们值不值得听真话。」",
    },
    {
      speaker: "主持人",
      text: "赫尔曼收回手指，地图上那枚地底堡垒的标记仍被压出一道浅痕。",
    },
    {
      speaker: "赫尔曼",
      text: "「骰子、报酬、信任、人情……这些听起来不像军令，但在深处，它们往往比军令更有用。」",
    },
    {
      speaker: "赫尔曼",
      text: "「记住，赏金猎人。你们不是去证明勇气的。勇气在地底不稀罕，能活着带回真相的人才稀罕。」",
    },
    {
      speaker: "瑟琳",
      text: "「那我们先去回声酒馆。找到合适的队友后，再回来领取正式下潜许可。」",
    },
    {
      speaker: "米娜",
      text: "「我会把你们的临时编队登记为待确认状态。五人到齐，能力缺口补齐，公会才会放行。」",
    },
    {
      speaker: "主持人",
      text: "你接过米娜递来的临时登记铜牌。铜牌还带着炉火的余温，可地图上通往深层的那条线，却冷得像一截没有尽头的铁索。",
    },
  ],
  hints: [
    "前往回声酒馆找萨洛打听三名队友",
...
const TAVERN_INTRO: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: '直到你们提到"公会"两个字，他才停下手里的动作，抬眼看了过来。那目光不算锋利，却像能把人心里的犹豫和底牌都照出来。',
    },
    ...
    {
      speaker: "瑟琳",
      text: "「我们需要补齐远征队的人手。公会说，你知道谁适合这次下潜。」",
    },
    {
      speaker: "萨洛",
      text: "「适合？这词听着比\u2018愿意送死\u2019体面多了。」",
    },
    {
      speaker: "主持人",
    ...
    {
      speaker: "萨洛",
      text: "「让我猜猜。你们缺一个能救命的人，一个能在孢海里认路的人，还缺一个懂地下规矩、知道哪扇门不该从正面开的家伙。」",
    },
    { speaker: "主持人", text: "瑟琳微微眯起眼，似乎在判断萨洛究竟知道多少。" },
    { speaker: "瑟琳", text: "「看来米娜没有说错。你确实知道该去找谁。」" },
    {
      speaker: "萨洛",
      text: "「我知道很多人。知道他们的下落、习惯、脾气，欠过谁的人情，喝醉以后会说什么梦话……这座城里有些事，公会档案不会写，但酒馆会记得。」",
    },
    {
      speaker: "主持人",
    ...
    {
      speaker: "萨洛",
      text: "「赢了，我告诉你们该找谁。输了，我也会给线索，但你们得承认一件事——这间酒馆，比公会更懂人。」",
    },
    {
      speaker: "主持人",
    ...
    {
      speaker: "瑟琳",
      text: "「他不是单纯在刁难我们。他想判断我们值不值得听真话，也想判断那些人能不能交给我们。」",
    },
    {
      speaker: "主持人",
...
const SALO_COMPANION_INTEL: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "萨洛",
      text: "「愿赌服输。你们缺治疗、缺向导，还缺一个懂地下规矩的人。我倒是知道三个合适的。」",
    },
    {
      speaker: "萨洛",
      text: "「先说艾琳——静默神殿的白枝修女。她今晚在神殿，为阵亡守卫主持安魂仪式。去的时候脚步轻些，她不喜欢有人把死者的安宁当成过场。」",
    },
    {
      speaker: "萨洛",
      text: "「她会治疗，会净化，也能把快崩溃的人从噩梦边上拉回来。但记住，她不是随队药箱。你若把伤员当累赘，她会第一个停下脚步。」",
    },
    {
      speaker: "萨洛",
      text: "「第二个，布洛克·铁锅。他就在二楼。别看他整天抱着酒杯，他闻一闻靴底的泥，就知道你从哪片菌毯踩回来。」",
    },
    {
      speaker: "萨洛",
      text: "「孢海的风向、毒囊的颜色、魔物什么时候迁徙，他比公会地图还熟。想请动他，带上采样许可和报酬，再陪他喝一轮。他不信空话，只信酒后还站得稳的人。」",
    },
    {
      speaker: "萨洛",
      text: "「至于第三个，凯娅。她在黑市。那姑娘开锁像翻书，拆陷阱像解谜，听暗号时比神殿司祭听祷词还认真。」",
    },
    {
      speaker: "主持人",
      text: "萨洛撕下一张窄纸条，在上面写下一句话，又用指节压着推到你面前。",
    },
    {
      speaker: "萨洛",
      text: "「找她的时候，先说我告诉你的这句：\u2018断缆不问来路。\u2019这不是信物，只能让她愿意听你把话说完。」",
    },
    {
      speaker: "萨洛",
      text: "「但她只相信看得见的筹码。公会徽记在她眼里不值钱，这张纸条也最多只能让她愿意听你把话说完。」",
    },
    {
      speaker: "萨洛",
    ...
    {
      speaker: "瑟琳",
      text: "「明白了。先去静默神殿找艾琳，再回来见布洛克，最后带着暗号和筹码去黑市找凯娅。」",
    },
    {
      speaker: "萨洛",
...
const BROCK_TAVERN_INTRO: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "那里坐着一个宽肩矮壮的男人。铁锅搁在桌边，酒杯压着一张皱巴巴的孢海草图，旁边还摊着几片晒干的菌片。",
    },
    {
      speaker: "布洛克",
    ...
    {
      speaker: "布洛克",
      text: "「我听见了。所以我才还坐着，没把他们赶出去。」",
    },
    {
      speaker: "主持人",
      text: "布洛克捻起一片干菌，放在鼻前闻了闻，又把它丢回袋子里。那动作随意，却像是在检查某种比地图更可靠的证据。",
    },
    {
      speaker: "布洛克",
      text: "「公会的人总说自己只是采样。结果呢？会发光的、会咬人的、会救命的，全被他们塞进箱子，最后再问我为什么箱子会长腿逃跑。」",
    },
    {
      speaker: "艾琳",
      text: "「我们不是来搬空孢海的。我们需要你带路，也需要你告诉我们哪些东西不能碰。」",
    },
    { speaker: "布洛克", text: "「这话比\u2018为了城市\u2019顺耳一点。」" },
    {
      speaker: "主持人",
      text: "他抬眼看向艾琳，又看了看你们，目光停在沾着神殿白光的护腕上。粗硬的眉毛微微松了些。",
    },
    {
      speaker: "布洛克",
      text: "「白枝修会的修女都来了？看来这次不是普通送死队。」",
    },
    {
      speaker: "瑟琳",
      text: "「我们准备进入无光孢海，调查堡垒失联和魔物上涌。那里的深层环境远比公会记录复杂，所以想请你担任向导。」",
    },
    {
      speaker: "布洛克",
      text: "「说得对。孢海不会因为你带着公会徽记就让路。风向错了，呼吸会骗你；颜色错了，水也能毒死人。」",
    },
    {
      speaker: "主持人",
      text: "布洛克把酒杯推到桌中央，杯底撞在木桌上，发出沉闷的一声。",
    },
    ...
    {
      speaker: "布洛克",
      text: "「孢海里的气味、毒尘、幻听，比这杯酒难受多了。连酒劲都扛不住的人，到了下面只会把同伴认成怪物。」",
    },
    {
      speaker: "萨洛",
      text: "「三轮。先过体质豁免，再拼骰子点数。站得稳是一种本事，知道什么时候停手，也是。」",
    },
    {
      speaker: "布洛克",
      text: "「赢了，我带路。输了也不是不能谈，但下去以后，谁敢乱碰菌毯，我就用这口锅敲醒谁。」",
    },
    {
      speaker: "瑟琳",
      text: "「小心点。他不是在玩酒桌游戏，而是在看你失去优势时会不会乱来。」",
    },
    {
      speaker: "布洛克",
      text: "「银杖小姐说得没错。来吧，让我看看你们是一支队伍，还是一群会走路的事故。」",
    },
  ],
  hints: [
    "陪布洛克喝得尽兴",
...
const BROCK_RECRUITED: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "布洛克",
      text: "「但条件先说清楚。下去以后，帮我采集三份活性孢子。要活的，不能烧，不能泡酒，更不能像上次那群蠢货一样，把活样本扔进城市排水沟。」",
    },
    { speaker: "艾琳", text: "「活性孢子如果处理不当，会污染浅层水道。」" },
    { speaker: "布洛克", text: "「听见没？修女都比公会仓库管理员懂这个。」" },
    {
      speaker: "瑟琳",
      text: "「报酬由公会结算，采样流程和样本归属会写进附约。我们也会按你的要求处理样本。」",
    },
    { speaker: "布洛克", text: "「你说话像本账册，不过账册至少可靠。」" },
    {
      speaker: "主持人",
      text: "布洛克把桌上的菌片一片片收回袋子，又将铁锅扣在背包外侧。锅底磕上铁扣，发出沉稳的一声。",
    },
    {
      speaker: "布洛克",
    ...
    {
      speaker: "萨洛",
      text: "「恭喜，你们获得了一名向导，以及一口会骂人的锅。」",
    },
    { speaker: "布洛克", text: "「锅比你可靠。」" },
    {
      speaker: "主持人",
      text: "萨洛笑着继续擦杯子。远征队里，又多了一名熟悉孢海、脾气粗硬却经验可靠的生存专家。",
    },
  ],
  hints: [
    "前往黑市寻找凯娅",
...
const BLACK_MARKET_KAIYA_INTRO: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "瑟琳没有替你开口。她只看了一眼你收好的纸条，又退后半步，把说出暗号的机会交给你。",
    },
  ],
  hints: [],
};
...
const BLACK_MARKET_KAIYA_CONTACT: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "凯娅",
      text: "「放心，一枚都没少。我只是想确认，公会这次派来的究竟是远征队，还是一群连口袋都看不住的尸体。」",
    },
...
const YUNLING_FAREWELL: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "护身符用细绳系着，里面封着一片干燥的蓝色菌叶和一小截白枝烛芯，外壳被磨得很光滑，像是被人反复握过。",
    },
    { speaker: "云苓", text: "「这个也拿着。」" },
    { speaker: "艾琳", text: "「护身符？」" },
    {
      speaker: "云苓",
      text: "「不是神迹，也不是保命符。只是能让人想起来，呼吸乱的时候先停一下，手发抖的时候别急着拔剑。」",
    },
    {
      speaker: "云苓",
      text: "「下了孢海以后，别逞强，别乱喝药，别把疼痛当勇敢。能回来买第二次药的人，才算真正聪明。」",
    },
    {
      speaker: "主持人",
      text: "她把护身符推到你面前，语气依旧平静，却难得没有催你们付钱或让路。",
    },
    {
      speaker: "云苓",
      text: "「愿你们走过毒雾时还记得自己的名字，听见黑暗说话时还认得同伴的声音。」",
    },
    {
      speaker: "云苓",
      text: "「还有……活着回来。欠我的药钱也好，没买的药也好，都可以下次再算。」",
    },
    {
      speaker: "主持人",
      text: "你收下护身符。细绳落入掌心时，带着一点药铺里的温度，也带着某种说不清的安心感。",
    },
  ],
  hints: ["返回公会登记"],
};
...
const YUNLING_BLACK_MARKET: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "凯娅",
      text: "「萨洛连她都告诉你们了？别看云苓年纪小，她配的药比黑市里大多数大人都可靠。」",
    },
    {
      speaker: "主持人",
    ...
    {
      speaker: "主持人",
      text: "柜台后坐着一个穿青灰长衣的小女孩。她踩着高脚凳，用银针拨弄一片蓝色菌叶，听见脚步才抬起头。",
    },
    { speaker: "凯娅", text: "「云苓。萨洛介绍来的，他们准备下无光孢海。」" },
    {
      speaker: "云苓",
      text: "「还没领远征装备，就先来找药？不错。至少你们知道，武器能杀怪物，药才能让人走得更远。」",
    },
    ...
    {
      speaker: "主持人",
      text: "云苓从柜台下搬出几只颜色不同的小药瓶，按顺序排成一列。",
    },
    {
      speaker: "云苓",
    ...
    {
      speaker: "云苓",
      text: "「看在萨洛的面子上，这三瓶治疗药水送你们。流血、骨裂、体力透支都能用，但别擦破点皮就喝，深层里补给比金币贵。」",
    },
    {
      speaker: "主持人",
    ...
    {
      speaker: "云苓",
      text: "「那个叫净化之心。要是有人被黑石侵蚀，却还没完全失去自我，它也许能把人拉回来。」",
    },
    {
      speaker: "云苓",
      text: "「它不是常备药，是给最糟糕的情况准备的。现在嫌贵没关系，等真正需要时，你们可能连后悔的时间都没有。」",
    },
  ],
  hints: ["购买力量药水", "购买治疗药水", "购买净化之心", "返回公会登记"],
};
...
const GUILD_FINAL_REGISTRATION: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "你们回到公会任务室时，炉火已经烧低。地图桌旁空出了五个签名位，旁边摆着临时编队铜牌和一支沾着黑墨的羽笔。",
    },
    {
      speaker: "主持人",
      text: "桌面上铺着降渊路线图。缆梯、孢海据点、黑石之门和地底堡垒被红线依次连起，最深处的地心之门封印则被厚重的红蜡圈住。",
    },
    {
      speaker: "主持人",
      text: "赫尔曼站在地图前，黑石单片镜映着烛火，却没有半点暖意。米娜则将队伍契约、物资清单和一只沉重的公会补给箱推到桌上。箱体边缘还残留着旧远征队的编号刻痕。",
    },

    {
      speaker: "赫尔曼",
      text: "「五人到齐。赏金猎人{name}，逆钟学派观测法师瑟琳，白枝修女艾琳，深层生存专家布洛克，以及黑市暗线协助者凯娅。」",
    },
    {
      speaker: "主持人",
      text: "他的目光依次扫过每个人，像是在确认你们不是名单上的名字，而是真正会走进深处的人。",
    },
    {
      speaker: "赫尔曼",
      text: "「治疗、净化、法术观测、孢海生存、机关暗线和正面行动能力已经补齐。从规则上说，你们有资格领取下潜许可。」",
    },
    ...
    {
      speaker: "主持人",
      text: "米娜翻开契约，指尖压住最上方的任务条款。她的声音依旧平稳，却比第一次见面时更慢了一些。",
    },
    {
      speaker: "米娜",
      text: "「第一，前往地底堡垒；第二，调查堡垒与历次远征队失联原因；第三，确认地心之门封印状态；第四，查明深层魔物上涌源头。」",
    },
    {
      speaker: "米娜",
      text: "「如发现生还者，优先带回。如无法带回，则必须取得可靠证据。遗物、记录、影像石、样本编号都可以，口头猜测不会被登记为调查结果。」",
    },
    ...
    {
      speaker: "主持人",
      text: "他用手杖点了点地图上那道黑色门形标记。木桌发出沉闷的一声，像有什么东西在地底深处回应。",
    },
    {
      speaker: "赫尔曼",
      text: "「不要指望公会能及时支援。降渊缆梯只能送你们下去，不能保证把你们完整带回来。」",
    },
    {
      speaker: "布洛克",
      text: "「这话倒是实在。下面真出事，能救命的通常不是规章，是绳扣、方向感和别乱碰东西的脑子。」",
    },
    { speaker: "赫尔曼", text: "「所以你在队伍里。」" },

    {
      speaker: "主持人",
      text: "米娜打开补给箱。抗孢面罩、冷光灯、止血粉、解毒剂、缆梯安全扣、样本瓶和密封滤网被分门别类地固定在箱内，每一格都贴着编号。",
    },
    {
      speaker: "米娜",
    ...
    {
      speaker: "艾琳",
      text: "「急救包和解毒剂交给我检查。下去之后，任何伤口都要先处理，再决定是否继续行动。」",
    },
    {
      speaker: "布洛克",
      text: "「样本瓶和滤网我来管。孢海里的东西不是装进瓶子就算采样，封错了，整支队伍都得跟着倒霉。」",
    },
    {
      speaker: "凯娅",
      text: "「我检查锁扣、暗袋和箱底。公会物资也不是没有被人调包过，尤其是写着\u2018全新\u2019两个字的时候。」",
    },
    { speaker: "米娜", text: "「这批是我亲自封存的。」" },
    {
      speaker: "凯娅",
      text: "「那我就更该看看。认真负责的人，也会被不认真负责的人拖累。」",
    },
    {
      speaker: "瑟琳",
      text: "「我会记录法阵反应、污染波动、主缆震动残响和队伍状态。进入深层后，任何异常都必须第一时间汇报。」",
    },

    {
      speaker: "主持人",
      text: "你在契约末尾签下名字。墨迹尚未干透，瑟琳便在旁边写下属于逆钟学派的细长签名。",
    },
    {
      speaker: "主持人",
      text: "艾琳的字迹端正而温和，布洛克的签名像被斧头劈进纸里，凯娅则只留下一个利落的短名，像随时准备从契约边缘溜走。",
    },
    {
      speaker: "主持人",
      text: "五个名字并排落在同一张远征契约上。那一刻，任务室里安静了下来，连补给箱里的玻璃瓶碰撞声都显得格外清楚。",
    },

    {
      speaker: "赫尔曼",
      text: "「从现在起，你们是逆穹城第七远征小队。任务目标确认，风险等级记为最高。」",
    },
    {
      speaker: "赫尔曼",
      text: "「我不要求你们像英雄一样下去。我只要求你们像活人一样回来。」",
    },
    {
      speaker: "米娜",
...
const ELEVATOR_DESCENT: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "主持人",
      text: "降渊缆梯中枢位于逆穹城最下缘。九条秘银主缆自穹顶垂入深井，巨型绞盘缓慢转动，层层咬合的齿轮声在空洞中回荡，像某种沉睡巨兽压得极低的呼吸。",
    },
    {
      speaker: "主持人",
      text: "护栏之外，蓝绿色孢光在深渊下方一层层漂浮，时明时暗。吊舱悬在轨道尽头，金属外壳覆着冷白霜痕，只等最后一次安全核验。",
    },
    {
      speaker: "温妮",
      text: "「站稳，别把手伸到护栏外。上一个这么做的人，现在只剩一只手套还挂在三号缆上。」",
    },
    {
      speaker: "主持人",
      text: "检修台后探出一个矮个子的少女。她脸上沾着机油，护目镜被推到额头上，怀里夹着一卷厚得吓人的缆梯维护图，腰间挂满扳手、铜尺和叮当作响的小铜铃。",
    },
    {
      speaker: "温妮",
      text: "「温妮·铜铃，缆梯检修员。你们要是能完整回来，记得顺便告诉公会——我的维护预算至少该再翻一倍。」",
    },
    {
      speaker: "主持人",
      text: "她一边说，一边俯身检查吊舱锁扣，动作利落得像在给一头脾气古怪的机械兽套上缰绳。",
    },
    {
      speaker: "温妮",
      text: "「我看看……治疗、银杖、孢海向导、黑市手，再加一个负责站在最前面的。」",
    },
    {
      speaker: "温妮",
      text: "「配置不错。至少不像前几支队伍那样，光看名单就知道是在给深渊送饭。」",
    },
    { speaker: "布洛克", text: "「这孩子嘴不讨喜，但她看缆索的本事是真的。」" },
    { speaker: "温妮", text: "「谢谢。你夸人也一样不中听。」" },
    {
      speaker: "主持人",
      text: "温妮把一枚测振铜片贴上主缆，铜片立刻发出细小的颤鸣。她皱了皱眉，把结果记进油污斑驳的记录板。",
    },
    {
      speaker: "温妮",
      text: "「听好了。最近主缆回响比记录快了半拍，绞盘负载也在涨。机械不会撒谎，下面有东西正在影响缆梯。」",
    },
    {
      speaker: "瑟琳",
      text: "「我也记录到了异常震动残响。不是单纯磨损，更像深层有什么东西在干扰回路。」",
    },
    {
      speaker: "温妮",
      text: "「对，所以别把这趟路当成普通升降。下去以后，安全扣别离身，冷光灯别乱晃，听见缆索尖叫就立刻趴低。」",
    },
    { speaker: "温妮", text: "「你们怕不怕我不管，缆梯只怕乱动的人。」" },
    {
      speaker: "艾琳",
      text: "「我会盯着队伍状态。若有人呼吸紊乱或出现眩晕，立刻停下检查。」",
    },
    {
      speaker: "凯娅",
      text: "「我喜欢她。至少她把\u2018会死人\u2019这件事说得很清楚。」",
    },
    { speaker: "温妮", text: "「那你应该也会喜欢这个——」" },
    {
      speaker: "主持人",
      text: "她把五枚缆梯安全扣依次拍到你们手里，金属冰得像刚从井底捞出来。",
    },
    {
      speaker: "温妮",
      text: "「挂好，锁紧，别嫌麻烦。等真掉下去的时候，你们会发现规则比祈祷可靠。」",
    },
    { speaker: "瑟琳", text: "「装备确认。所有人上吊舱，安全扣锁紧。」" },
    {
      speaker: "主持人",
      text: "吊舱铁门在齿轮牵引下缓缓打开，深渊的冷风立刻从下方涌上来，带着湿冷矿尘、金属腥气和极淡的孢粉甜味。",
    },
    {
      speaker: "主持人",
      text: "你们依次踏入吊舱。随着最后一道锁扣合拢，逆穹城的灯火被栏杆切碎在身后，而真正的幽暗深层，正沿着主缆下方无声张开。",
    },
  ],
  hints: [
...
const SPORE_OUTPOST_ARRIVAL: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "主持人",
      text: "吊舱最终落在一座钉入岩壁的钢木平台上。平台被数根铆钉梁死死咬进石层，脚下每一步都能听见金属在深处发出轻微的回响。",
    },
    {
      speaker: "主持人",
      text: "这里仍有符文灯、守卫和补给箱，却安静得不像一处前线据点。那不是秩序带来的安静，而像所有人都在刻意压低呼吸，生怕被黑暗里的什么东西听见。",
    },
    {
      speaker: "主持人",
      text: "淡蓝色孢尘覆在护栏、箱盖和守卫肩甲上，像一层没有融化的霜。平台外侧，巨型真菌如倒塌塔楼般从黑暗中升起，菌盖深处闪着不规律的冷光，忽明忽暗，像远处正在眨动的眼睛。",
    },

    {
      speaker: "主持人",
      text: "一名披着旧守夜披风的男人从灯影里走出。他背着短弩，肩上别着一枚蓝伞形状的旧徽记，靴边和披风下摆都沾满了洗不净的孢粉。",
    },
    {
      speaker: "尼布",
    ...
    {
      speaker: "主持人",
      text: "尼布点了点头，没有露出欢迎的神情，只是多看了你们几眼，像是在确认这次下来的人能活多久。",
    },

    {
      speaker: "尼布",
      text: "「浅层地图可以给你们，旧巡逻记录也还能翻。但先记住两件事。」",
    },
    {
      speaker: "主持人",
      text: "他把一卷卷边发潮的地图拍在补给箱上，手指随即按住其中几处被深蓝墨水反复圈出的区域。",
    },
    {
      speaker: "尼布",
      text: "「第一，别追那些异常荧光。它们有些会移动，有些会引路，还有些专门把人带到菌毯边界外面去。」",
    },
    {
      speaker: "尼布",
      text: "「第二，别回应远处的喊声。会喊人的东西，不一定还是人；有些声音甚至不是在叫你，只是在学你们城里人说话。」",
    },
  ],
  hints: ["整理阵亡者名册", "翻看旧巡逻记录"],
  clues: [
    {
      id: "spore_sea_map",
      name: "无光孢海地图",
      description:
        "尼布交给你的浅层巡逻地图。标注了蓝伞浅滩、骨柱湿地、废弃据点和黑石之门的大致方位，但更深处仍是一片空白。",
      source: "孢海据点 · 尼布",
      tags: ["孢海", "地图", "关键道具"],
...
const OUTPOST_NAME_LIST: ScriptedScene = {
  ...
  statePatch: {
    ...
    last_event: "整理了据点记录板上的第三巡逻队残缺名册",
  },
  events: ["整理第三巡逻队残缺名册", "艾琳信任+5"],
  lastEvent: "在孢海据点整理阵亡者名册，确认第三巡逻队部分成员",
  hints: [],
  lines: [
    {
      speaker: "主持人",
      text: "你走到据点内侧的记录板前。几枚身份牌被临时钉在木板上，有的完整，有的只剩半截，旁边的姓名栏还空着。",
    },
    {
      speaker: "艾琳",
      text: "「这些不是数字。每一个空格后面，都有一个等不到消息的人。」",
    },
    {
      speaker: "主持人",
      text: "你逐一核对身份牌、遗物和残缺名册，从被孢尘浸花的字迹里整理出第三巡逻队的部分名单。",
    },
  ...
  clues: [
    {
      id: "clue_third_patrol_roster",
      name: "第三巡逻队残缺名册",
      description:
        "你在孢海据点整理出的残缺名册，记录了第三巡逻队的部分姓名与遗物。",
      source: "孢海据点·记录板",
      tags: ["巡逻队", "名册", "调查"],
    },
  ],
...
const OUTPOST_PATROL_LOG: ScriptedScene = {
  ...
  statePatch: {
    ...
    clue_voice_mimic: true,
    route_broken_bridge_unlocked: true,
    last_event: "翻看了旧巡逻记录",
  },
  events: ["发现巡逻记录中的偏航线索"],
  ...
  lines: [
    {
      speaker: "主持人",
      text: "你翻开旧巡逻记录。最近几页的墨迹比前面潦草，路线标记被反复划掉，又用深蓝墨水重新圈起。",
    },
    { speaker: "瑟琳", text: "「这里。第三巡逻队原本不该靠近东侧断梁。」" },
    {
      speaker: "布洛克",
      text: "「他们偏航了。风向不对，脚印却往荧光更亮的地方去了。」",
    },
    {
      speaker: "主持人",
      text: "最后一行记录写得极重：东侧断梁后方传来求救声，疑似失踪队员，第三巡逻队改变路线，随后未归。",
    },
    { speaker: "尼布", text: "「我告诉过他们，别回应远处的喊声。」" },
    { speaker: "凯娅", text: "「他们还是去了。」" },
    {
      speaker: "尼布",
      text: "「人就是这样。明知道可能是陷阱，还是会希望那真的是同伴。」",
    },
  ],
  clues: [
    {
      id: "clue_patrol_log_page",
      name: "巡逻记录残页",
      description: "第三巡逻队在东侧断梁附近听见求救声后偏离路线，随后未归。",
      source: "孢海据点·巡逻记录本",
      tags: ["巡逻队", "记录", "调查"],
    },
  ],
...
const AILIN_WOUNDED_PRE: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "艾琳的脚步忽然停下。她的目光越过补给箱，落向平台角落。那里有两名守卫裹着毛毯靠在墙边，呼吸急促，指缝和颈侧残留着没能完全净化掉的暗色孢痕。",
    },
    {
      speaker: "主持人",
      text: "其中一人似乎已经烧得神志不清，嘴唇不断开合，反复念着几个模糊的名字。另一人怀里攥着半截断裂的身份牌，指节因为用力而发白。",
    },
    {
      speaker: "艾琳",
      text: "「他们不是普通孢毒。污染已经进了伤口，还伴随精神错乱。」",
    },
    {
      speaker: "尼布",
      text: "「第三巡逻队带回来的。活着回来的只有这两个，其他人……还没来得及写进名册。」",
    },
    { speaker: "艾琳", text: "「没写进名册，就等于还没人替他们确认死亡。」" },
    {
      speaker: "尼布",
      text: "「据点人手不够。我们只能先守住平台，没人有空慢慢核对遗物和证词。」",
    },
    { speaker: "艾琳", text: "「伤者要稳定，阵亡者也要有名字。」" },
    {
      speaker: "主持人",
      text: "她握紧药箱提带，指尖因为用力而微微发白。你想起她在静默神殿说过的话：能救的人要救，无法带回的人，至少要带回名字。",
    },
    {
      speaker: "瑟琳",
      text: "「如果现在停下，进入孢海的时间会延后。但这些伤员也许知道第三巡逻队遭遇了什么。」",
    },
    {
      speaker: "布洛克",
      text: "「耽误一点时间，总比带着瞎眼情报往菌毯里撞强。」",
    },
    {
      speaker: "凯娅",
      text: "「而且那半截身份牌看起来不是自然断的。有人在混乱里抢过它。」",
    },
    {
      speaker: "艾琳",
      text: "「{name}，我想留下来先处理他们。不是为了拖慢队伍，而是因为我们接下来要走的路，可能正是他们没能走完的那条。」",
    },
  ],
...
const AILIN_SIDEQUEST: ScriptedScene = {
  ...
  statePatch: {
    ...
    wounded_guard_stabilized: true,
  },
  events: ["艾琳揭露身世", "记录了第三巡逻队姓名", "稳定了伤员"],
  lastEvent:
    "艾琳揭露了成为修女的真正原因，并完整记录了第三巡逻队的失踪成员姓名",
  lines: [
    {
      speaker: "主持人",
      text: "你们将两名伤员抬到避风的符文灯下。平台外侧的孢光一明一暗，像有什么东西正在黑暗里缓慢呼吸。",
    },
    {
      speaker: "艾琳",
      text: "「把他们的面罩解开一半，别完全摘掉。布洛克，压住他的肩膀；凯娅，帮我找身份牌和随身物。」",
    },
    { speaker: "布洛克", text: "「这人烧得不轻。孢毒进血了。」" },
    { speaker: "艾琳", text: "「还没到放弃的时候。」" },
    {
      speaker: "主持人",
      text: "艾琳取出白枝圣徽，将净化光压进伤员发黑的伤口。伤员猛地弓起身体，像是被什么看不见的东西从梦里拖了出来。",
    },
    ...
    {
      speaker: "凯娅",
      text: "「找到了。半截身份牌，还有一张被孢尘泡烂的巡逻名册。」",
    },
    { speaker: "艾琳", text: "「给我。」" },
    {
      speaker: "主持人",
      text: "艾琳接过身份牌，小心擦去上面的孢尘。牌面只剩半个名字，边缘像是被人硬生生掰断。",
    },
    ...
    {
      speaker: "主持人",
      text: "短暂的沉默里，只有伤员急促的呼吸声和远处绞盘的回响。艾琳没有立刻解释，而是先把伤口重新包好。",
    },
    {
      speaker: "艾琳",
      text: "「我小时候住在城市下缘。那时候我父亲是缆梯守卫，负责接应从深层回来的远征队。」",
    },
    {
      speaker: "艾琳",
      text: "「有一年，深层回来的吊舱只带回了三只补给箱和一面烧黑的队旗。名单上写着：失踪十二人。」",
    },
    { speaker: "艾琳", text: "「其中一个是我父亲。」" },
    {
      speaker: "主持人",
      text: "她说得很平静，像这段话已经在心里重复过无数遍，早就磨去了最锋利的痛。",
    },
    {
      speaker: "艾琳",
      text: "「公会那时候很忙。新的事故、新的失踪、新的委托，一件接一件。对他们来说，那只是十二个未归名额。」",
    },
    {
      speaker: "艾琳",
      text: "「可对我来说，那不是一个数字。那是一个会在换班后给我带热面包的人，是会把破掉的护腕重新缝好的人。」",
    },
    { speaker: "瑟琳", text: "「后来呢？」" },
    {
      speaker: "艾琳",
      text: "「静默神殿的一位白枝修女陪我找了三个月。最后，她只找到一枚烧裂的身份牌。」",
    },
    {
      speaker: "艾琳",
      text: "「她把身份牌交给我时说：\u2018人也许回不来了，但名字不能留在下面。名字是死者回家的路。\u2019」",
    },
    {
      speaker: "主持人",
      text: "艾琳低头看着手中的半截身份牌，拇指轻轻擦过残缺的刻痕。",
    },
    {
      speaker: "艾琳",
      text: "「所以我去了静默神殿。起初只是想学会怎么替父亲祈祷，后来才明白，祈祷不是让痛苦消失。」",
    },
    {
      speaker: "艾琳",
      text: "「祈祷是提醒活着的人，不要把别人的痛苦整理成一串方便归档的数字。」",
    },
    { speaker: "伤员", text: "「名字……我记得……队长叫……」" },
    {
      speaker: "主持人",
      text: "伤员忽然攥住艾琳的袖口，像是拼命抓住一根即将断开的缆绳。",
    },
    { speaker: "艾琳", text: "「慢慢说，我在听。」" },
    {
      speaker: "伤员",
      text: "「罗德……伊芙……还有……还有卡恩……别让他们……别让他们没人知道……」",
    },
    {
      speaker: "主持人",
      text: "艾琳没有打断他。她一边维持净化术，一边用另一只手把这些名字写在名册残页上。每写下一个名字，笔尖都停顿片刻。",
    },
...
const AILIN_SIDEQUEST_COMPLETE: ScriptedScene = {
  ...
  statePatch: {
    ...
    ailin_purification_report_obtained: true,
    third_patrol_names_recorded: true,
    third_patrol_names_confirmed: true,
  ...
  lines: [
    {
      speaker: "主持人",
      text: "伤员的呼吸终于平稳下来。尼布叫来守卫，将他们抬回据点内侧的临时病床。",
    },
    {
      speaker: "尼布",
      text: "「我会把这些名字补进据点名册。至少他们不会只剩一句未归。」",
    },
    { speaker: "艾琳", text: "「谢谢。」" },
    {
      speaker: "尼布",
      text: "「该谢的是你们。这里的人守久了，有时候会忘记自己不是石头。」",
    },
    { speaker: "布洛克", text: "「走吧。再拖下去，风向该变了。」" },
    {
      speaker: "凯娅",
      text: "「而且我们现在知道了：浅滩外的声音不可信，身份牌也可能被人动过。比空着手进去强。」",
    },
    {
      speaker: "瑟琳",
      text: "「我已将伤员证词和第三巡逻队姓名记录标入路线备注。进入孢海后，若听见呼喊，全队不得擅自回应。」",
    },
    {
      speaker: "主持人",
      text: "艾琳另抄了一份伤员污染程度、净化用量和意识反应记录，题为《伤员净化报告》，交给你收进档案袋。",
    },
    { speaker: "艾琳", text: "「我准备好了。」" },
    {
      speaker: "主持人",
      text: "艾琳重新背起药箱。白枝圣徽在孢光下泛着柔和的亮，像一盏不愿熄灭的小灯。",
    },
  ],
  clues: [
    {
      id: "clue_third_patrol_names",
      name: "第三巡逻队姓名记录",
      description:
        "艾琳根据伤员证词整理出的姓名记录。上面写着罗德、伊芙、卡恩等名字。",
      source: "孢海据点·伤员证词",
      tags: ["巡逻队", "姓名", "调查"],
    },
    {
      id: "clue_broken_identity_tag",
      name: "断裂的身份牌",
      description:
        "第三巡逻队伤员身上的半截身份牌，断口很新，似乎有人在混乱中争抢过它。",
      source: "孢海据点·伤员随身物",
      tags: ["巡逻队", "身份牌", "调查"],
    },
  ],
...
const IGNORE_AILIN: ScriptedScene = {
  ...
  statePatch: {
    ...
    wounded_testimony_missed: true,
    ailin_sidequest_skipped: true,
  },
  ...
  lines: [
    {
      speaker: "主持人",
      text: "你没有停下。平台外侧的孢光仍在闪烁，吊舱后的符文灯把你们的影子拉得很长。",
    },
    { speaker: "艾琳", text: "「……现在就走？」" },
    {
      speaker: "瑟琳",
      text: "「继续前进能节省时间，但我们会失去确认伤员证词的机会。」",
    },
    {
      speaker: "布洛克",
      text: "「路是你选的。只是别忘了，孢海里没问清楚的事，通常会在更糟的时候追上来。」",
    },
    {
      speaker: "凯娅",
      text: "「无视麻烦不等于麻烦消失。只是它会换个地方等你。」",
    },
    {
      speaker: "主持人",
      text: "艾琳沉默地收紧药箱提带。她没有争辩，也没有离队，只是走回队伍时，脚步比之前慢了一些。",
    },
    {
      speaker: "艾琳",
      text: "「我会继续履行队伍职责。伤者、孢毒和污染，我都会处理。」",
    },
...
const ENTER_BLUE_SHOAL: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "主持人",
      text: "你们离开孢海据点时，身后的符文灯一点点远去。钢木平台的轮廓被孢尘吞没，只剩尼布最后一句警告还像冷铁一样压在耳边。",
    },
    {
      speaker: "尼布",
      text: "「记住，别追异常荧光，别回应远处喊声。能分清同伴声音的人，才有机会回来。」",
    },
    {
      speaker: "主持人",
      text: "前方没有真正意义上的道路，只有几条被旧巡逻队踩出的浅痕，在蓝绿色孢光里若隐若现。每走一步，靴底都会陷进柔软的菌毯，发出潮湿而细小的声响。",
    },
    {
      speaker: "布洛克",
      text: "「跟着我踩过的地方走。别嫌慢，孢海里走快的人通常都被埋得很浅。」",
    },
    { speaker: "凯娅", text: "「听起来像是经验之谈。」" },
    { speaker: "布洛克", text: "「是。也是别人用命留下来的教程。」" },
    {
      speaker: "主持人",
      text: "空气里的味道渐渐变甜，像发酵的果酒，又像潮湿木头长出霉斑后的气息。抗孢面罩隔住了大部分孢尘，却挡不住那股让人隐隐犯困的闷意。",
    },
    {
      speaker: "艾琳",
      text: "「如果有人胸口发紧、眼前发亮，立刻告诉我。不要等到自己站不稳。」",
    },
    {
      speaker: "瑟琳",
      text: "「主缆残响正在减弱，孢尘浓度上升。我们已经离开据点防护范围。」",
    },
    {
      speaker: "主持人",
    ...
    {
      speaker: "主持人",
      text: "菌盖边缘垂下细长的发光菌丝，随风轻轻摇晃。远远望去，它们像一盏盏沉在黑暗里的灯，又像许多悬在半空的水母。",
    },
    {
      speaker: "主持人",
      text: "浅滩地面覆盖着厚厚的蓝色菌毯，积水在菌毯缝隙间缓慢流动，倒映出头顶菌盖的冷光。偶尔有孢泡从水面浮起，破裂时散出一圈细小的荧光尘。",
    },
    { speaker: "凯娅", text: "「这里漂亮得不像安全地方。」" },
    {
      speaker: "布洛克",
      text: "「你终于说了句对的。蓝伞浅滩平时不会亮成这样。」",
    },
    { speaker: "瑟琳", text: "「亮度变化有规律吗？」" },
    {
      speaker: "布洛克",
      text: "「没有。正常蓝伞菌会跟风向一起闪，像呼吸。现在这些……更像是在互相传信。」",
    },
    {
      speaker: "主持人",
      text: "话音刚落，远处一片菌盖忽然亮起，随后另一片、第三片、第四片接连回应。冷蓝色光斑沿着浅滩深处一路扩散，像有什么看不见的东西正在水面下移动。",
    },
    { speaker: "艾琳", text: "「那里有人影。」" },
    {
      speaker: "主持人",
      text: "菌丝帘幕后，几个模糊的轮廓一闪而过。它们的高度接近人类，动作却过于僵硬，像被看不见的线吊着前行。",
    },
    { speaker: "凯娅", text: "「不对。没有脚步声。」" },
    { speaker: "布洛克", text: "「也没有呼吸声。」" },
    {
      speaker: "主持人",
      text: "风从浅滩深处吹来，带来一阵极轻的呼喊。那声音断断续续，像被厚厚的菌毯捂住，又像有人隔着很远的水面喊你们。",
    },
    {
      condition: "flags.clue_voice_mimic",
      speaker: "瑟琳",
      text: "「别回应。巡逻记录里提到过，第三巡逻队就是在听见求救声后偏离路线。」",
    },
    {
      condition: "flags.wounded_guard_stabilized",
      speaker: "艾琳",
      text: "「伤员说过，那声音会模仿死者。所有人保持队形，不要离开灯光范围。」",
    },
    {
      condition: "!flags.clue_voice_mimic && !flags.wounded_guard_stabilized",
      speaker: "瑟琳",
      text: "「声音来源不稳定。它不像正常回声，更像在试探我们的反应。」",
    },
    {
      speaker: "主持人",
      text: "你们没有回应。那声音停顿片刻，忽然变得更近。菌毯深处鼓起几个圆形凸包，像有什么东西正从下面顶开湿软的地面。",
    },
    { speaker: "布洛克", text: "「后退半步，别踩到鼓起来的地方！」" },
    {
      speaker: "主持人",
      text: "第一团凸包猛地破开，喷出一阵蓝绿色孢尘。几只覆满菌丝的兽形生物从菌毯下爬出，骨刺与菌壳纠缠在一起，空洞的眼窝里亮着冷光。",
    },
    { speaker: "艾琳", text: "「孢化兽……它们已经不是普通野兽了。」" },
    {
      speaker: "主持人",
      text: "与此同时，先前那些人影也从菌丝帘幕后滑了出来。它们没有五官，身体像由一团团湿软菌块拼成，却从腹腔里发出断续的人声。",
    },
    ...
    {
      speaker: "瑟琳",
      text: "「第七远征小队，准备战斗。保持距离，不要让孢尘包围队伍。」",
    },
    {
      speaker: "主持人",
      text: "蓝伞浅滩的冷光骤然变亮。孢兽压低身体，菌团在水面上缓慢铺开，战斗已经无法避免。",
    },
  ],
  hints: [],
  battlePrep: [
    {
      ...
      successText:
        "你们没有回应那些求救声。结合先前的线索，你们迅速判断出声音并非来自活人，而是拟声菌团在试探队伍反应。",
      failText:
        "你们虽然没有立刻回应，但那声音越来越像熟悉的人。短暂的迟疑让队伍阵型出现了一瞬间松动。",
      successEffect: {
    ...
    },
    {
      ...
      successText:
        "符文灯的冷光刺入菌团腹腔，你们看见几枚暗蓝色核心正在湿软菌块中缓慢收缩。那些断续的求救声短暂失真，变成了刺耳杂音。",
      failText:
        "符文灯扫过菌团身体，却只照出一层层湿软菌块。下一刻，菌团突然模仿出你们的声音，干扰了队伍判断。",
      successEffect: {
      ...
      failEffect: {
        ...
        battleEffects: {
          enemyTypeBuff: {
            enemyType: "fungal_mimic",
            initiativeBonusFirstRound: 2,
          },
        },
      },
    },
    {
      ...
      successText:
        "布洛克用斧柄敲了敲几处鼓起的菌毯，立刻示意众人后撤。下一秒，孢化兽从你们原本站立的位置破土而出，却扑了个空。",
      failText:
        "你们刚刚后撤，另一侧菌毯却猛然炸开。孢化兽从意料之外的位置冲出，逼得前排仓促举盾。",
      successEffect: {
        flags: { blue_shoal_prep_avoid_bulges_success: true },
        battleEffects: {
          targetEnemyType: "spore_crawler",
    ...
    },
    {
      ...
      successText:
        "你们重新压紧抗孢面罩，放慢呼吸。甜腻的孢尘气味被隔在面罩之外，脑中的昏沉感稍稍退去。",
      successEffect: {
...
const ACT1_BLUE_SHOAL_AFTERMATH_COMPRESSED: ScriptedScene = {
  id: "act1-blue-shoal-aftermath-compressed",
  manualOnly: true,
  triggers: ["蓝伞浅滩战后余波"],
  setArea: "无光孢海·蓝伞浅滩",
  ...
  statePatch: {
    ...
    currentNodeId: "act1-blue-shoal-aftermath-compressed",
  },
  lastEvent: "蓝伞浅滩的战斗结束，队伍发现通往黑石根区的远征标记",
  lines: [
    {
      speaker: "主持人",
      text: "最后一只孢化地底兽倒在蓝伞菌的冷光下。浅滩重新安静，只剩水滴从破损的护甲上滑落。",
    },
    { speaker: "布洛克", text: "「这不是普通的巡逻队徽记。是旧远征要塞的。」" },
    { speaker: "凯娅", text: "「路标指向黑石根区。旧路还没有完全塌。」" },
    {
      speaker: "瑟琳",
      text: "「我们走那条路。再绕远，就会错过黑石脉冲的间隔。」",
    },
  ],
  hints: ["沿远征标记前往黑石根区"],
};
...
const ACT1_BLACK_ROOT_ENTRANCE: ScriptedScene = {
  ...
  statePatch: {
    ...
    currentNodeId: "act1-black-root-entrance",
  },
  lastEvent: "抵达黑石根区入口，发现幸存者的血迹",
  lines: [
    {
      speaker: "主持人",
      text: "菌丝在这里变得像烧焦的树根，深深嵌进岩层。一枚破损的方尖碑碎片卡在旧路标旁。",
    },
...
const ACT1_LAIN_SURVIVOR: ScriptedScene = {
  ...
  lines: [
    {
      speaker: "主持人",
      text: "一名披着旧远征斗篷的男人靠在断墙下。他的呼吸很浅，手里死死攅着半枚身份牌。",
    },
...
const ACT1_SERIN_CRACK: ScriptedScene = {
  id: "act1-black-root-rest-serin-crack",
  manualOnly: true,
  triggers: ["黑石根区休整"],
  ...
  lines: [
    {
      speaker: "主持人",
      text: "休整时，你看见瑟琳正用手指按住银杖上一道新的裂纹。裂纹里的冷光与黑石脉冲同步闪动。",
    },
...
const ACT1_ENDINGS: ScriptedScene[] = [
  ...
  [
    ...
    "带伤者穿门",
    "核心碎裂，封锁随之崩塌。莱因咳出一口黑血，但你们没有丢下他，一同穿过破碎的石门。",
  ],
  [
    "cold-expedition",
    "冷静的远征",
    "核心稳定，封锁保留。队伍没有停下等待任何人，只带着沉默与任务穿过黑石门。",
  ],
  [
    "gate-split-open",
    "裂门而下",
    "核心粉碎，封锁解除。黑石门在你们面前轰然洞开，没有幸存者，也没有回头的理由。",
  ],
].map(([id, title, text]) => ({
  id: `act1-ending-${id}`,
  manualOnly: true,
...
const ACT1_OCEAN_REVEAL: ScriptedScene = {
  ...
  lines: [
    ...
    {
      speaker: "主持人",
      text: "一片没有天空的地下海洋在你们脚下展开。远处的微光像灯塔一样在黑潮上明灭。",
    },
...
const ACT1_GAME_COMPLETE: ScriptedScene = {
  ...
  lastEvent: "第一幕结束",
  lines: [
    { speaker: "主持人", text: "第一幕《地心之门》结束。你的选择已被记录。" },
  ],
  hints: ["[第一幕结束]"],
};

const ACT1_BAD_ENDING: ScriptedScene = {
  id: "act1-bad-ending-time-reset",
  manualOnly: true,
  triggers: ["逆时归零"],
  setArea: "逆时归零",
  bgImage: "/assets/scenes/29.webp",
  ...
  statePatch: {
    ...
    currentNodeId: "act1-bad-ending-time-reset",
...
export const SCRIPTED_SCENES: ScriptedScene[] = [
  ...
  IGNORE_AILIN,
  ENTER_BLUE_SHOAL,
  // [已停用/归档] ABANDONED_FORWARD_POST, // 凯娅旧支线入口
  RHEIN_ENCOUNTER,
  PRE_BOSS_REST,
  BLACKSTONE_CORE_CHOICE,
