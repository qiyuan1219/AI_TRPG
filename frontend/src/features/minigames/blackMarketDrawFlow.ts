...
export const ORLAN_DRAW_COST = 50;
export const ORLAN_PITY_LIMIT = 10;
export const ORLAN_DIAMOND_MIN_ROLL = 18;

export const ORLAN_REWARD_TABLE: OrlanRewardItem[] = [
  { itemId: 'copper_ring', name: '生锈铜戒指', count: 1, type: '旧物', min: 1, max: 2, icon: '/assets/icons/items/aolan_blindbox/copper_ring.png', desc: '边缘磨得发黑，奥兰坚持说它曾经属于一位勇敢的人。' },
  { itemId: 'old_talisman_fragments', name: '旧护符碎片', count: 1, type: '材料', min: 3, max: 4, icon: '/assets/icons/items/aolan_blindbox/old_talisman_fragments.png', desc: '残缺的护符碎片，表面还有几道不完整的祈愿纹。' },
  { itemId: 'hemostatic_powder', name: '止血粉', count: 1, type: '消耗品', min: 5, max: 6, icon: '/assets/icons/items/aolan_blindbox/hemostatic_powder.png', desc: '可用于处理普通流血伤口，味道像苦涩的铁锈。' },
  { itemId: 'weakly_effective_detoxifying_agent', name: '弱效解毒剂', count: 1, type: '消耗品', min: 7, max: 8, icon: '/assets/icons/items/aolan_blindbox/weakly_effective_detoxifying_agent.png', desc: '能缓解轻微毒素，但对深层污染效果有限。' },
  { itemId: 'cold_light_stick', name: '冷光棒', count: 1, type: '探索', min: 9, max: 10, icon: '/assets/icons/items/aolan_blindbox/cold_light_stick.png', desc: '短时间照亮周围环境，不会产生明显热源。' },
  { itemId: 'sealed_sample_bottle', name: '密封样本瓶', count: 1, type: '探索', min: 11, max: 13, icon: '/assets/icons/items/aolan_blindbox/sealed_sample_bottle.png', desc: '可用于保存孢子、菌丝或污染残留。' },
  { itemId: 'small_bottle_therapeutic_solution', name: '小瓶治疗药水', count: 1, type: '消耗品', min: 14, max: 16, icon: '/assets/icons/items/aolan_blindbox/small_bottle_therapeutic_solution.png', desc: '能恢复少量生命，适合应急。' },
  { itemId: 'blackmarket_chips', name: '黑市筹码', count: 1, type: '特殊', min: 17, max: 17, icon: '/assets/icons/items/aolan_blindbox/blackmarket_chips.png', desc: '黑市流通的小筹码，也许以后能派上用场。' },
];
...
export const ORLAN_DIAMOND_REWARD: OrlanRewardItem = {
  ...
  count: 1,
  type: '关键道具',
  icon: '/assets/icons/items/aolan_blindbox/diamond.png',
